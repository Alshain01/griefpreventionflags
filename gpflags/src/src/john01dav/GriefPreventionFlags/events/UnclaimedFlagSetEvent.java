 ...
 * 
 */
public class UnclaimedFlagSetEvent extends Event implements Cancellable{
	 ...
	 */
	public UnclaimedFlagSetEvent(World world, Type type, CommandSender sender, boolean value) {
		this.type = type;
		this.sender = sender;
		this.value = value;
		this.world = world;
